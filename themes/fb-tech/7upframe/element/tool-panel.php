    ...
    function s7upf_vc_tool_panel($attr)
    {
                        ...
                        <div class="widget-indexdm-inner">
                            <div class="dm-header">
                                ...
                                <div class="header-button">
                                    <a target="_blank" class="btn-arrow color" href="'.esc_url($buy_link).'" title="Buy Now"><span>Buy Now</span></a>                  
                                </div>
                            </div>
        ...
        if(is_array($data)){
            foreach ($data as $key => $value){
                ...
                if(!empty($value['link']) and !empty($value['title']))
...
vc_map( array(
    "name"      => esc_html__("SV Tool Panel", 'seeshop'),
    ...
    "params"    => array(
        array(
            "type" => "textfield",
            "holder" => "div",
            "heading" => esc_html__("Title",'seeshop'),
            "param_name" => "title",
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Support link",'seeshop'),
            "param_name" => "sp_link",
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Documentation",'seeshop'),
            "param_name" => "doc_link",
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Buy Link",'seeshop'),
            "param_name" => "buy_link",
        ),
        array(
            "type" => "attach_image",
            "heading" => esc_html__("Image",'seeshop'),
            "param_name" => "image",
        ),
        array(
            "type" => "param_group",
            "heading" => esc_html__("Demo List",'seeshop'),
            "param_name" => "demos",
            "params"    => array(
                array(
                    "type"          => "textfield",
                ...
                array(
                    "type"          => "textfield",
                    "heading"       => esc_html__("Link",'seeshop'),
                    "param_name"    => "link",
                ),
                array(
                    "type" => "attach_image",
                    "heading" => esc_html__("Image item",'seeshop'),
                    "param_name" => "image_item",
                ),
                array(
                    "type"          => "textfield",
                    "heading"       => esc_html__("Image preview Link",'seeshop'),
